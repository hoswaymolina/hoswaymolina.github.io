...
In other words: To find the probability of winning the game, we must find **(for every possible $n_1$)** the probability of winning *given a draw of* $n_1$ AND drawing $n_1$ in the first place, then summing all 100 of these probabilities. For example, consider $n_1 = 1$. The probability of winning given a draw of $1$ is 100%, while the probability of drawing a $1$ is 1%. So, the probability of drawing a 

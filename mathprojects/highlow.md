...
In Google Sheets, I placed each $n_1$ from 1 through 100 in column A. Column B calculates $P(W|B_n)$ with the simple formula `=(100-A2)/99` for $n_1 \le 50$, and `=(A52-1)/99` for $n_1 \ge 51$.

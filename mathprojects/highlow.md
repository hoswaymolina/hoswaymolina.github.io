...
In other words: To find the probability of winning the game, we must find the probability of winning *given a draw of* $n_1$ AND drawing $n_1$ in the first place **for every possible $n$** and then summing all 100 of these probabilities.
